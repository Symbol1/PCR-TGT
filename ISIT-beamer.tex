...
\begin{frame}\frametitle{How to Detect DNA and What's Ct Value?}
	\begin{tikzpicture}[overlay, shift={(10,-5.2)}]
	...
	\pp
	\alert{Ct value} is \#cycles before we see the tube glowing.
\end{frame}
...
\pgfplotstableread{
	...
	Tropical           $2^{-∞},2^{-40},\dotsc,2^{-12}$   $\min(30,15)=15$    
	Semiquantitative   $[0,3),[3,6),[6,9),\dotsc$        $[0,3)+[3,6)=[3,9)$ 
	Quantitative       $0,1,2,3,4,5,\dotsc$              $8+9=17$            
}\tablequant
\begin{frame}\centering
